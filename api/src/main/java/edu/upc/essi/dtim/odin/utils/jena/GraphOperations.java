...
//    public Model getGraph(String iri){
//
//        return Txn.calculateRead(jena.getPersistentDataset(), ()-> {
//            if(jena.getPersistentDataset().containsNamedModel(iri)){
//                Model m = jena.getPersistentDataset().getNamedModel(iri);
////                return ModelFactory.createModelForGraph(m.getGraph());
//                return ModelFactory.createDefaultModel().add(m);
//            }
//            return null;
...
//
//    public void addModel(String namedGraph, Model model){
//        Txn.executeWrite(jena.getPersistentDataset(), ()-> {
//            Model graph = jena.getPersistentDataset().getNamedModel(namedGraph);
//            graph.add(model);
//        });
//    }
//
...
//    public void removeGraph(String iri){
//        Txn.executeWrite(jena.getPersistentDataset(), ()-> {
//            jena.getPersistentDataset().removeNamedModel(iri);
//        });
//    }
//
//    public void addTriple(String namedGraph, String s, String p, String o) {
...
//    public void deleteTriples(String graphIRI,String subjectIRI, String predicateIRI, String objectIRI) {
//        Txn.executeWrite(jena.getPersistentDataset(), ()->{
//            Model graph = jena.getPersistentDataset().getNamedModel(graphIRI);
//            graph.remove(new ResourceImpl(subjectIRI), new PropertyImpl(predicateIRI), new ResourceImpl(objectIRI));
//        });
//    }
//    public void deleteAllTriples(String namedGraph){
...
//
//            Txn.executeWrite(jena.getPersistentDataset(), ()-> {
//                Iterator<String> graphNames = jena.getPersistentDataset().listNames();
//                List<String> graphs = new ArrayList<>();
//                while (graphNames.hasNext()) {
//                    graphs.add(graphNames.next());
//
//                }
//                graphs.forEach(iri -> jena.getPersistentDataset().removeNamedModel(iri));
//            }) ;
//
//
//
...
//    public ResultSet runAQuery(Query query) {
//
//        ResultSet resultSet = Txn.calculateRead(jena.getPersistentDataset(), ()-> {
//            try(QueryExecution qExec = QueryExecutionFactory.create(query, jena.getPersistentDataset())) {
////                qExec.getContext().set(Symbols.unionDefaultGraph, true);
//
//                return ResultSetFactory.copyResults(qExec.execSelect()) ;
//            } catch ( Exception e) {
...
//
//            try {
//                UpdateAction.parseExecute(sparqlQuery, jena.getPersistentDataset());
//            } catch (Exception e) {
//                LOGGER.error("Error occurred while Updating a quiery");
//            }
//        });
