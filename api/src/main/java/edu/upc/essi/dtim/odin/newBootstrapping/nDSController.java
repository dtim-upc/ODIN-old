...
//
//    @PostMapping("persist")
//    public ResponseEntity<newDataSource> persistDataSource(Authentication authentication, @PathVariable("id") String id, @RequestPart newDataSource dataSource) {
...
//            project.setGraphicalSchema(dataSource.getGraphicalSchema());
//        } {
////            we should also persist the integration...?
//
//
//        }
//
